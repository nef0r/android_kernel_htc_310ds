...
UINT32 A5142_LITEON_MIPI_RAWSensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 A5142_QTECH_MIPI_RAWSensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 BF3905_MIPI_YUVSensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
/* BY WHYPHVNTXM BEGIN*/
#if defined(A5142_LITEON_MIPI_RAW)
    {A5142_LITEON_MIPI_RAW_SENSOR_ID, SENSOR_DRVNAME_A5142_LITEON_MIPI_RAW, A5142_LITEON_MIPI_RAW_SensorInit},
#endif

#if defined(A5142_QTECH_MIPI_RAW)
    {A5142_QTECH_MIPI_RAW_SENSOR_ID, SENSOR_DRVNAME_A5142_QTECH_MIPI_RAW, A5142_QTECH_MIPI_RAW+SensorInit},
#endif

#if defined(BF3905_MIPI_YUV)
    {BF3905MIPI_YUV_SENSOR_ID, SENSOR_DRVNAME_BF3905MIPI_YUV, BF3905MIPI_YUV_SensorInit},
#endif
/* BY WHYPHVNTXM END*/
