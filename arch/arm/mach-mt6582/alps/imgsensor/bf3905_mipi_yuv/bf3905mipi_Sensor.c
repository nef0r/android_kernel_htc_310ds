...
*******/
	...
	BF3905_MIPI_write_cmos_sensor(0x3e,0x03); ////////0x83  for black line under low light, ldo for doubler smaller.
	BF3905_MIPI_write_cmos_sensor(0x2f,0x04); ////0x84 VDDP volt
	BF3905_MIPI_write_cmos_sensor(0x16,0xe3);//0xa1  0xaf for black line under low light, bias current setting for pixel output follower 0xa1
	BF3905_MIPI_write_cmos_sensor(0x6c,0xa2);/////////0xc2 for black line under low light, ldo for doubler smaller.
	BF3905_MIPI_write_cmos_sensor(0x27,0x98);///for black line under low light
	...
	BF3905_MIPI_write_cmos_sensor(0x35,0x32);
	BF3905_MIPI_write_cmos_sensor(0x65,0x24);
	BF3905_MIPI_write_cmos_sensor(0x66,0x24);
	BF3905_MIPI_write_cmos_sensor(0xbd,0xf4);
	BF3905_MIPI_write_cmos_sensor(0xbe,0x46);
	...
	BF3905_MIPI_write_cmos_sensor(0x7a,0x34); //0x23
	...
	BF3905_MIPI_write_cmos_sensor(0x97,0x45);
	...
	BF3905_MIPI_write_cmos_sensor(0x86,0xa0); ///0xc0
	BF3905_MIPI_write_cmos_sensor(0x89,0x73);
	BF3905_MIPI_write_cmos_sensor(0x8f,0x81);
	BF3905_MIPI_write_cmos_sensor(0x94,0x92);
	...
	#if 1 //for nice color and sharpness
	BF3905_MIPI_write_cmos_sensor(0x39,0xb0);
	BF3905_MIPI_write_cmos_sensor(0x3f,0xb0);
	BF3905_MIPI_write_cmos_sensor(0x90,0x20);
	BF3905_MIPI_write_cmos_sensor(0x91,0xd0);
	//gamma nice and pretty    qingxiliangli                                                  
	...
	#else /// close for debug to colorful and sharpness,noise is secondary 20140111  
	BF3905_MIPI_write_cmos_sensor(0x39,0xa3);
	BF3905_MIPI_write_cmos_sensor(0x3f,0xa3);
	BF3905_MIPI_write_cmos_sensor(0x90,0x20);
	...
	BF3905_MIPI_write_cmos_sensor(0xa3,0x24);
	BF3905_MIPI_write_cmos_sensor(0xa4,0x0b);
	BF3905_MIPI_write_cmos_sensor(0xa5,0x25);
	BF3905_MIPI_write_cmos_sensor(0xa6,0x03);
	BF3905_MIPI_write_cmos_sensor(0xa7,0x15);
	...
	BF3905_MIPI_write_cmos_sensor(0xd1,0x20); //00
	...
	BF3905_MIPI_write_cmos_sensor(0xd4,0x1a);
	...
	BF3905_MIPI_write_cmos_sensor(0xb1,0xc0);
	BF3905_MIPI_write_cmos_sensor(0xb2,0xb0);
	BF3905_MIPI_write_cmos_sensor(0x55,0x00);
	BF3905_MIPI_write_cmos_sensor(0x56,0x40);

#else //version 1.0
	BF3905_MIPI_write_cmos_sensor(0x12, 0x80);  //Bit[7]:1-soft reset      
	BF3905_MIPI_write_cmos_sensor(0x15, 0x12);  //Bit[1]: VSYNC option; Bit[0]: HREF    option
	BF3905_MIPI_write_cmos_sensor(0x09, 0x01);  //Bit[7]: Soft sleep mode; Bit[6:0]: Drive capability 
	BF3905_MIPI_write_cmos_sensor(0x12, 0x00);
	BF3905_MIPI_write_cmos_sensor(0x3a, 0x20);  //YUV422 Sequence
	BF3905_MIPI_write_cmos_sensor(0x1e, 0x40); 
	...
	//banding
	BF3905_MIPI_write_cmos_sensor(0x8a, 0x96);  //50 hz banding  
	BF3905_MIPI_write_cmos_sensor(0x8b, 0x7d);  //60 hz banding 

	//initial AWB and AE                                                     
	BF3905_MIPI_write_cmos_sensor(0x13, 0x00);  //Manual AWB & AE    
	BF3905_MIPI_write_cmos_sensor(0x01, 0x15);
	BF3905_MIPI_write_cmos_sensor(0x02, 0x23);
	BF3905_MIPI_write_cmos_sensor(0x9d, 0x20);
	BF3905_MIPI_write_cmos_sensor(0x8c, 0x02);
	...
	BF3905_MIPI_write_cmos_sensor(0x6e, 0x20);
	BF3905_MIPI_write_cmos_sensor(0xbc, 0x0d);
	BF3905_MIPI_write_cmos_sensor(0x35, 0x30); //lens shading gain of R
	BF3905_MIPI_write_cmos_sensor(0x65, 0x2a); //lens shading gain of G
	BF3905_MIPI_write_cmos_sensor(0x66, 0x2a); //lens shading gain of B
	BF3905_MIPI_write_cmos_sensor(0xbd, 0xf4);
	...
	BF3905_MIPI_write_cmos_sensor(0x70, 0x0b);
	BF3905_MIPI_write_cmos_sensor(0x73, 0x27); //0x73[7:4]: The bigger, the smaller noise; 0x73[3:0]: The smaller, the smaller noise 
	BF3905_MIPI_write_cmos_sensor(0x79, 0x24);
	BF3905_MIPI_write_cmos_sensor(0x7a, 0x12); //0x7a[6:4]: Bright edge enhancement; 0x7a[2:0]: Dark edge enhancement
	...
	// gamma default
	BF3905_MIPI_write_cmos_sensor(0x39, 0x9c); 
	BF3905_MIPI_write_cmos_sensor(0x3f, 0x9c); 
	BF3905_MIPI_write_cmos_sensor(0x90, 0x20); 
	BF3905_MIPI_write_cmos_sensor(0x91, 0xd0);
	BF3905_MIPI_write_cmos_sensor(0x40, 0x3b);                
	BF3905_MIPI_write_cmos_sensor(0x41, 0x36);                 
	...
	BF3905_MIPI_write_cmos_sensor(0x52, 0x35);
	BF3905_MIPI_write_cmos_sensor(0x53, 0x9e);
	...
	BF3905_MIPI_write_cmos_sensor(0xb0, 0xe0);
	BF3905_MIPI_write_cmos_sensor(0xb3, 0x48);
	BF3905_MIPI_write_cmos_sensor(0xb4, 0xe3);//bit[7]: A light saturation
	BF3905_MIPI_write_cmos_sensor(0xb1, 0xf0);
	BF3905_MIPI_write_cmos_sensor(0xb2, 0xa0);
	BF3905_MIPI_write_cmos_sensor(0xb4, 0x63);///bit[7]: non-A light saturation
	BF3905_MIPI_write_cmos_sensor(0xb1, 0xb0);
	BF3905_MIPI_write_cmos_sensor(0xb2, 0xa0);                                                                              

	                                                   
	//AE       
	BF3905_MIPI_write_cmos_sensor(0x13, 0x07);                                 
	BF3905_MIPI_write_cmos_sensor(0x24, 0x4a); // AE Target 
	BF3905_MIPI_write_cmos_sensor(0x25, 0x88); // Bit[7:4]: AE_LOC_INT; Bit[3:0]:AE_LOC_GLB  
	BF3905_MIPI_write_cmos_sensor(0x97, 0x3c); // AE target value2.           
	BF3905_MIPI_write_cmos_sensor(0x98, 0x8a); // AE 窗口和权重 
	BF3905_MIPI_write_cmos_sensor(0x80, 0xd0); //Bit[3:2]: the bigger, Y_AVER_MODIFY is smaller     
	BF3905_MIPI_write_cmos_sensor(0x81, 0x00); //AE speed 
	BF3905_MIPI_write_cmos_sensor(0x82, 0x2a); //minimum global gain  
	BF3905_MIPI_write_cmos_sensor(0x83, 0x54);                
	BF3905_MIPI_write_cmos_sensor(0x84, 0x39);              
	BF3905_MIPI_write_cmos_sensor(0x85, 0x5d);                
	BF3905_MIPI_write_cmos_sensor(0x86, 0x88); //maximum gain  
	BF3905_MIPI_write_cmos_sensor(0x89, 0x63); //INT_MAX_MID  
	BF3905_MIPI_write_cmos_sensor(0x94, 0x82); //Bit[7:4]: Threshold for over exposure pixels, the smaller, the more over exposure pixels; Bit[3:0]: 
	                                     //Control the start of AE.
	...
	BF3905_MIPI_write_cmos_sensor(0xa1, 0x31);	      
	BF3905_MIPI_write_cmos_sensor(0xa2, 0x0d);  //the low limit of blue gain for indoor scene
	BF3905_MIPI_write_cmos_sensor(0xa3, 0x27);  //the upper limit of blue gain for indoor scene
	BF3905_MIPI_write_cmos_sensor(0xa4, 0x0a);  //the low limit of red gain for indoor scene
	BF3905_MIPI_write_cmos_sensor(0xa5, 0x2c);  //the upper limit of red gain for indoor scene
	BF3905_MIPI_write_cmos_sensor(0xa6, 0x04)
	BF3905_MIPI_write_cmos_sensor(0xa7, 0x1a);  //Base B gain 不建议修改                 
	BF3905_MIPI_write_cmos_sensor(0xa8, 0x18);  //Base R gain不建议修改               
	...
	BF3905_MIPI_write_cmos_sensor(0xd0, 0x92);
...
void BF3905_MIPI_night_mode(kal_bool enable)
{
    ...
    if(enable)
    	...
    	BF3905_MIPI_set_min_framerate(6);
    	}
    	...
    	BF3905_MIPI_set_min_framerate(9);
		}
...
UINT32 BF3905_MIPIOpen(void)
{
	...
	kal_uint16 sensor_id=0;
	sensor_id=((BF3905_MIPI_read_cmos_sensor(0xfc)<<8)|(BF3905_MIPI_read_cmos_sensor(0xfd)));
	printk("====== bf3905mipi_Sensor_CCI_20140120.c (Line Noise in Low Light) ======\r\n");
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	BF3905_MIPI_set_mirror(IMAGE_HV_MIRROR);
...
BOOL BF3905_MIPI_set_param_banding(UINT16 para)
{
    ...
    switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			SENSORDB("BF3905_MIPI_set_param_banding 50hz \n");
			int_step_50 = BF3905_MIPICurrentStatus.iInterClock*100000/800/100;
			BF3905_MIPI_write_cmos_sensor(0x8a,int_step_50);
			BF3905_MIPI_write_cmos_sensor(0x80,BF3905_MIPI_read_cmos_sensor(0x80)|0x02); //0x80[1]=1, select 50hz banding filter
			spin_lock(&bf3905mipi_drv_lock);
		    BF3905_MIPICurrentStatus.iBanding = para;
		...
		case AE_FLICKER_MODE_60HZ:
			SENSORDB("BF3905_MIPI_set_param_banding 60hz \n");
			int_step_60 = BF3905_MIPICurrentStatus.iInterClock*100000/800/120;
			BF3905_MIPI_write_cmos_sensor(0x8b,int_step_60);
			BF3905_MIPI_write_cmos_sensor(0x80,BF3905_MIPI_read_cmos_sensor(0x80)&0xfd); //0x80[1]=0, select 60hz banding filter
			spin_lock(&bf3905mipi_drv_lock);
		    BF3905_MIPICurrentStatus.iBanding = para;
...
BOOL BF3905_MIPI_set_param_exposure(UINT16 para)
{
	...
	{
		case AE_EV_COMP_n23:
			BF3905_MIPI_write_cmos_sensor(0x24, 0x10); //EV -2
			break;
		case AE_EV_COMP_n10:
			BF3905_MIPI_write_cmos_sensor(0x24, 0x28); //EV -1
			break;
		case AE_EV_COMP_00:
			BF3905_MIPI_write_cmos_sensor(0x24, 0x48); //EV 0  //48
			break;
		case AE_EV_COMP_10:
...
BOOL BF3905_MIPI_set_param_saturation(UINT16 para)
{
	...
	switch (para)
	{
		...
		case ISP_SAT_MIDDLE:
			...
			BF3905_MIPI_write_cmos_sensor(0xb2, 0xa0);
			BF3905_MIPI_write_cmos_sensor(0xb4, 0x63);
			BF3905_MIPI_write_cmos_sensor(0xb1, 0xc0); //middle
			BF3905_MIPI_write_cmos_sensor(0xb2, 0xb0);
			break;
		case ISP_SAT_HIGH:
			BF3905_MIPI_write_cmos_sensor(0xb4, 0xe3);
...
BOOL BF3905_MIPI_set_param_edge(UINT16 para)
{
	...
	switch (para)
	{
		...
		case ISP_EDGE_MIDDLE:
			BF3905_MIPI_write_cmos_sensor(0x7a, 0x34);	//middle
			BF3905_MIPI_write_cmos_sensor(0x73, 0x27);
			break;
		case ISP_EDGE_HIGH:
